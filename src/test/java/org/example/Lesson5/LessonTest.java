...
public class LessonTest extends AbstractTest {
    ...
    void myActiontest() throws InterruptedException {
        ...
        search.click(getDriver().findElement(By.className("svgicon flaticon flaticon--search")))
                .pause(1000l)
                .sendKeys(getDriver().findElement(By.className("svgicon flaticon flaticon--search")),"журнал")
                .pause(1000l)
                .click(getDriver().findElement(By.className("svgicon flaticon flaticon--search")))
                .build()
                .perform();
    ...
    @Disabled
    void voidTest(){
        WebElement voidElement = getDriver().findElement(By.className("svgicon flaticon flaticon--search"));
